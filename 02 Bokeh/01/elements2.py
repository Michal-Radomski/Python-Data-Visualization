...
from bokeh.models.annotations import Label, Span  # type: ignore[import-not-found]
from bokeh.plotting import figure  # type: ignore[import-not-found]
from bokeh.sampledata.periodic_table import elements  # type: ignore[import-not-found]
...
# Add labels to spans
label_span_gas_average_boil = Label(
    x=80,
    y=gas_average_boil,
